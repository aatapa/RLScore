...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/ajairo/anaconda3/lib/python3.6/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/ajairo/anaconda3/lib/python3.6/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "include_dirs": [
    ...
    "module_name": "rlscore.utilities.swapped"
}
END: Cython Metadata */
...
extern int __pyx_module_is_main_rlscore__utilities__swapped;
...
static const char __pyx_k_rlscore_utilities_swapped[] = "rlscore.utilities.swapped";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_rlscore_utilities_swapped_pyx[] = "rlscore/utilities/swapped.pyx";
...
static PyObject *__pyx_kp_s_rlscore_utilities_swapped_pyx;
...
/* "rlscore/utilities/swapped.pyx":61
 *         return n.parent.left
 * 
 * cdef node* uncle(node *n):             # <<<<<<<<<<<<<<
...
static __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_f_7rlscore_9utilities_7swapped_uncle(__pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_n) {
  ...
  /* "rlscore/utilities/swapped.pyx":62
 * 
 * cdef node* uncle(node *n):
 *     return sibling(n.parent)             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":64
 *     return sibling(n.parent)
 * 
 * cdef color node_color(node *n):             # <<<<<<<<<<<<<<
 *     if n == NULL:
...
static __pyx_t_7rlscore_9utilities_7swapped_color __pyx_f_7rlscore_9utilities_7swapped_node_color(__pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_n) {
  ...
  /* "rlscore/utilities/swapped.pyx":65
 * 
 * cdef color node_color(node *n):
 *     if n == NULL:             # <<<<<<<<<<<<<<
 *         return BLACK
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "rlscore/utilities/swapped.pyx":66
 * cdef color node_color(node *n):
 *     if n == NULL:
 *         return BLACK             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":68
 *         return BLACK
 *     else:
 *         return n.color             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":70
 *         return n.color
 * 
 * cdef rbtree* rbtree_create():             # <<<<<<<<<<<<<<
...
static __pyx_t_7rlscore_9utilities_7swapped_rbtree *__pyx_f_7rlscore_9utilities_7swapped_rbtree_create(void) {
  ...
  /* "rlscore/utilities/swapped.pyx":71
 * 
 * cdef rbtree* rbtree_create():
 *     cdef rbtree* t = <rbtree_t*> malloc(sizeof(rbtree_t));             # <<<<<<<<<<<<<<
 *     t.root = NULL
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":72
 * cdef rbtree* rbtree_create():
 *     cdef rbtree* t = <rbtree_t*> malloc(sizeof(rbtree_t));
 *     t.root = NULL             # <<<<<<<<<<<<<<
 *     return t
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":73
 *     cdef rbtree* t = <rbtree_t*> malloc(sizeof(rbtree_t));
 *     t.root = NULL
 *     return t             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":75
 *     return t
 * 
 * cdef node* new_node(double key, color node_color, node *left, node *right):             # <<<<<<<<<<<<<<
...
static __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_f_7rlscore_9utilities_7swapped_new_node(double __pyx_v_key, __pyx_t_7rlscore_9utilities_7swapped_color __pyx_v_node_color, __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_left, __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_right) {
  ...
  /* "rlscore/utilities/swapped.pyx":76
 * 
 * cdef node* new_node(double key, color node_color, node *left, node *right):
 *     cdef node* result = <node*> malloc(sizeof(rbtree_node_t))             # <<<<<<<<<<<<<<
 *     result.key = key
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":77
 * cdef node* new_node(double key, color node_color, node *left, node *right):
 *     cdef node* result = <node*> malloc(sizeof(rbtree_node_t))
 *     result.key = key             # <<<<<<<<<<<<<<
 *     result.color = node_color
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":88
 * cdef int rbtree_larger(rbtree *t, double key):
 *     cdef int larger = 0
 *     cdef node* n = t.root;             # <<<<<<<<<<<<<<
 *     while n != NULL:
 ...
 */
    ...
    /* "rlscore/utilities/swapped.pyx":94
 *                 larger += n.right.size
 *             return larger
 *         elif key > n.key:             # <<<<<<<<<<<<<<
 *             n = n.right
 ...
 */
    /*else*/ {
      ...
      if (__pyx_t_2) {
        ...
        /* "rlscore/utilities/swapped.pyx":98
 *         else:
 *             if n.right != NULL:
 *                 larger += n.right.size             # <<<<<<<<<<<<<<
 *             larger += n.duplicates+1;
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":101
 *             larger += n.duplicates+1;
 *             n = n.left
 *     return larger             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "rlscore/utilities/swapped.pyx":105
 * cdef void replace_node(rbtree *t, node *oldn, node *newn):
 *     if oldn.parent == NULL:
 *         t.root = newn             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":120
 *     if r.left != NULL:
 *         r.left.parent = n
 *     r.left = n             # <<<<<<<<<<<<<<
 *     n.parent = r
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":135
 *     if L.right != NULL:
 *         L.right.parent = n
 *     L.right = n             # <<<<<<<<<<<<<<
 *     n.parent = L
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":139
 *     L.size = n.size
 *     n.size = 1 + n.duplicates
 *     if n.left != NULL:             # <<<<<<<<<<<<<<
 *         n.size += n.left.size
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":141
 *     if n.left != NULL:
 *         n.size += n.left.size
 *     if n.right != NULL:             # <<<<<<<<<<<<<<
 *         n.size += n.right.size
...
static void __pyx_f_7rlscore_9utilities_7swapped_insert_case1(__pyx_t_7rlscore_9utilities_7swapped_rbtree *__pyx_v_t, __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_n) {
  ...
  /* "rlscore/utilities/swapped.pyx":145
 * 
 * cdef void insert_case1(rbtree *t, node *n):
 *     if n.parent == NULL:             # <<<<<<<<<<<<<<
 *         n.color = BLACK
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":154
 *         return
 *     else:
 *         insert_case3(t, n)             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":156
 *         insert_case3(t, n)
 * 
 * cdef void insert_case3(rbtree *t, node *n):             # <<<<<<<<<<<<<<
...
static void __pyx_f_7rlscore_9utilities_7swapped_insert_case3(__pyx_t_7rlscore_9utilities_7swapped_rbtree *__pyx_v_t, __pyx_t_7rlscore_9utilities_7swapped_node *__pyx_v_n) {
  ...
  /* "rlscore/utilities/swapped.pyx":157
 * 
 * cdef void insert_case3(rbtree *t, node *n):
 *     if node_color(uncle(n)) == RED:             # <<<<<<<<<<<<<<
 *         n.parent.color = BLACK
...
/* "rlscore/utilities/swapped.pyx":166
 * 
 * 
 ...
 */
    ...
    /* "rlscore/utilities/swapped.pyx":172
 *     elif (n == n.parent.left) and (n.parent == grandparent(n).right):
 *         rotate_right(t, n.parent)
 *         n = n.right             # <<<<<<<<<<<<<<
 *     insert_case5(t, n)
 ...
 */
      ...
      /* "rlscore/utilities/swapped.pyx":191
 *         while (True):
 *             n.size += 1 #the size of each visited node grows by one. Note that insertion of a duplicate key will also increment the size of the node where duplicate is inserted, and all its ancestors
 *             if key == n.key:             # <<<<<<<<<<<<<<
 *                 n.duplicates += 1 #inserted_node isn't going to be used, don't leak it
 ...
 */
        ...
        /* "rlscore/utilities/swapped.pyx":193
 *             if key == n.key:
 *                 n.duplicates += 1 #inserted_node isn't going to be used, don't leak it
 *                 free (inserted_node)             # <<<<<<<<<<<<<<
 *                 return
 ...
 */
        ...
        if (__pyx_t_2) {
          ...
          /* "rlscore/utilities/swapped.pyx":197
 *             elif key < n.key:
 *                 if n.left == NULL:
 *                     n.left = inserted_node             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
      /*else*/ {
        ...
        if (__pyx_t_2) {
          ...
          /* "rlscore/utilities/swapped.pyx":203
 *             else:
 *                 if n.right == NULL:
 *                     n.right = inserted_node             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
          ...
          /* "rlscore/utilities/swapped.pyx":204
 *                 if n.right == NULL:
 *                     n.right = inserted_node
 *                     break             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /* "rlscore/utilities/swapped.pyx":221
 *                 n = n.right
 *             else:
 *                 n2 = n             # <<<<<<<<<<<<<<
 *                 n = n.parent
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "rlscore/utilities/swapped.pyx":224
 *                 n = n.parent
 *                 if (n != NULL) and (n.left != NULL):
 *                     n.left = NULL             # <<<<<<<<<<<<<<
 *                 elif n != NULL:
 ...
 */
        ...
        /* "rlscore/utilities/swapped.pyx":227
 *                 elif n != NULL:
 *                     n.right = NULL
 *                 free(n2)             # <<<<<<<<<<<<<<
 *     free(t)
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":228
 *                     n.right = NULL
 *                 free(n2)
 *     free(t)             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":230
 *     free(t)
 * 
 * cdef double swapped_pairs(int len1, double *s, int len2, double *f):             # <<<<<<<<<<<<<<
 *     cdef int size = len1
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":242
 *     cdef double swpairs = 0.
 *     cdef int ties = 0
 *     while i < size:             # <<<<<<<<<<<<<<
 *         ties = 0
 ...
 */
    ...
    /* "rlscore/utilities/swapped.pyx":256
 *                     if s[k] != s[l]:
 *                         swpairs += 0.5
 *         while m<j:             # <<<<<<<<<<<<<<
 *             swpairs += rbtree_larger(t, s[m])
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":263
 *             i += 1
 *     delete_tree(t)
 *     return swpairs             # <<<<<<<<<<<<<<
 * 
...
/* "rlscore/utilities/swapped.pyx":265
 *     return swpairs
 * 
 * def count_swapped(cnp.ndarray[cnp.double_t,ndim=1] A, cnp.ndarray[cnp.double_t,ndim=1] B):             # <<<<<<<<<<<<<<
 *     I = np.argsort(B)
...
static PyObject *__pyx_pw_7rlscore_9utilities_7swapped_1count_swapped(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("count_swapped", 1, 2, 2, 1); __PYX_ERR(0, 265, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "count_swapped") < 0)) __PYX_ERR(0, 265, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("count_swapped", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 265, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("rlscore.utilities.swapped.count_swapped", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_A), __pyx_ptype_5numpy_ndarray, 1, "A", 0))) __PYX_ERR(0, 265, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_ptype_5numpy_ndarray, 1, "B", 0))) __PYX_ERR(0, 265, __pyx_L1_error)
...
static PyObject *__pyx_pf_7rlscore_9utilities_7swapped_count_swapped(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_A, PyArrayObject *__pyx_v_B) {
  ...
  __pyx_pybuffernd_B.rcbuffer = &__pyx_pybuffer_B;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_A.rcbuffer->pybuffer, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 265, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_B.rcbuffer->pybuffer, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 265, __pyx_L1_error)
  }
  ...
  /* "rlscore/utilities/swapped.pyx":266
 * 
 * def count_swapped(cnp.ndarray[cnp.double_t,ndim=1] A, cnp.ndarray[cnp.double_t,ndim=1] B):
 *     I = np.argsort(B)             # <<<<<<<<<<<<<<
 *     A = A[I]
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_argsort); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 266, __pyx_L1_error)
  ...
  if (!__pyx_t_2) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_3, ((PyObject *)__pyx_v_B)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 266, __pyx_L1_error)
  ...
  /* "rlscore/utilities/swapped.pyx":267
 * def count_swapped(cnp.ndarray[cnp.double_t,ndim=1] A, cnp.ndarray[cnp.double_t,ndim=1] B):
 *     I = np.argsort(B)
 *     A = A[I]             # <<<<<<<<<<<<<<
 *     B = B[I]
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_A), __pyx_v_I); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 267, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rlscore/utilities/swapped.pyx":268
 *     I = np.argsort(B)
 *     A = A[I]
 *     B = B[I]             # <<<<<<<<<<<<<<
 *     result = swapped_pairs(A.shape[0], <double*> A.data, B.shape[0], <double*> B.data)
 *     return result
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_B), __pyx_v_I); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 268, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rlscore/utilities/swapped.pyx":269
 *     A = A[I]
 *     B = B[I]
 *     result = swapped_pairs(A.shape[0], <double*> A.data, B.shape[0], <double*> B.data)             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  /* "rlscore/utilities/swapped.pyx":270
 *     B = B[I]
 *     result = swapped_pairs(A.shape[0], <double*> A.data, B.shape[0], <double*> B.data)
 *     return result             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_result); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_rlscore_utilities_swapped_pyx, __pyx_k_rlscore_utilities_swapped_pyx, sizeof(__pyx_k_rlscore_utilities_swapped_pyx), 0, 0, 1, 0},
 ...
 *     A = A[I]
 */
  __pyx_tuple__10 = PyTuple_Pack(4, __pyx_n_s_A, __pyx_n_s_B, __pyx_n_s_I, __pyx_n_s_result); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 265, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_rlscore_utilities_swapped_pyx, __pyx_n_s_count_swapped, 265, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 265, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_swapped(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "rlscore.utilities.swapped")) {
      if (unlikely(PyDict_SetItemString(modules, "rlscore.utilities.swapped", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     A = A[I]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7rlscore_9utilities_7swapped_1count_swapped, NULL, __pyx_n_s_rlscore_utilities_swapped); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 265, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_count_swapped, __pyx_t_1) < 0) __PYX_ERR(0, 265, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rlscore.utilities.swapped", 0, __pyx_lineno, __pyx_filename);
    }
