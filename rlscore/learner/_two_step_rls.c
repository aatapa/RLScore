...
static const char __pyx_k_invGhhGYGhh_ji[] = "invGhhGYGhh_ji";
static const char __pyx_k_invGhhGYGhh_jj[] = "invGhhGYGhh_jj";
...
static const char __pyx_k_home_aatapa_Dropbox_python_RLSc[] = "/home/aatapa/Dropbox/python/RLScore/rlscore/learner/_two_step_rls.pyx";
...
static PyObject *__pyx_pw_7rlscore_7learner_13_two_step_rls_1out_of_sample_loo_symmetric(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("out_of_sample_loo_symmetric (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 1); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_GY)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 2); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_GYG)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 3); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_results)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 4); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rowlen)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 5); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_collen)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, 6); __PYX_ERR(0, 32, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_G = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_G.memview)) __PYX_ERR(0, 32, __pyx_L3_error)
    ...
    __pyx_v_GY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2]); if (unlikely(!__pyx_v_GY.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_GYG = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3]); if (unlikely(!__pyx_v_GYG.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
    __pyx_v_results = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_results.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_rowlen = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_rowlen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_collen = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_collen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("out_of_sample_loo_symmetric", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 32, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_7rlscore_7learner_13_two_step_rls_out_of_sample_loo_symmetric(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_G, __Pyx_memviewslice __pyx_v_Y, __Pyx_memviewslice __pyx_v_GY, __Pyx_memviewslice __pyx_v_GYG, __Pyx_memviewslice __pyx_v_results, int __pyx_v_rowlen, int __pyx_v_collen) {
  ...
  /* "rlscore/learner/_two_step_rls.pyx":44
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "rlscore/learner/_two_step_rls.pyx":45
 * 
 *     for i in range(rowlen):
 *         for j in range(i+1, collen):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":61
 *             invGhh_jj = invdetGhh * G_ii
 *             GY_ii = GY[i, i]
 *             GY_ij = GY[i, j]             # <<<<<<<<<<<<<<
 *             GY_ji = GY[j, i]
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":63
 *             GY_ij = GY[i, j]
 *             GY_ji = GY[j, i]
 *             GY_jj = GY[j, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":67
 *             invGhhGYhh_ii = invGhh_ii * GY_ii + invGhh_ij * GY_ji
 *             invGhhGYhh_ij = invGhh_ii * GY_ij + invGhh_ij * GY_jj
 *             invGhhGYhh_ji = invGhh_ij * GY_ii + invGhh_jj * GY_ji             # <<<<<<<<<<<<<<
 *             invGhhGYhh_jj = invGhh_ij * GY_ij + invGhh_jj * GY_jj
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":69
 *             invGhhGYhh_ji = invGhh_ij * GY_ii + invGhh_jj * GY_ji
 *             invGhhGYhh_jj = invGhh_ij * GY_ij + invGhh_jj * GY_jj
 *             invGhhGYGhh_ii = invGhh_ii * GYG_ii + invGhh_ij * GYG_ij             # <<<<<<<<<<<<<<
 *             invGhhGYGhh_ij = invGhh_ii * GYG_ij + invGhh_ij * GYG_jj
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":73
 *             invGhhGYGhh_ji = invGhh_ij * GYG_ii + invGhh_jj * GYG_ij
 *             invGhhGYGhh_jj = invGhh_ij * GYG_ij + invGhh_jj * GYG_jj
 *             invGhhGYGhhinvGhh_ii = invGhhGYGhh_ii * invGhh_ii + invGhhGYGhh_ij * invGhh_ij             # <<<<<<<<<<<<<<
 *             invGhhGYGhhinvGhh_ij = invGhhGYGhh_ii * invGhh_ij + invGhhGYGhh_ij * invGhh_jj
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":74
 *             invGhhGYGhh_jj = invGhh_ij * GYG_ij + invGhh_jj * GYG_jj
 *             invGhhGYGhhinvGhh_ii = invGhhGYGhh_ii * invGhh_ii + invGhhGYGhh_ij * invGhh_ij
 *             invGhhGYGhhinvGhh_ij = invGhhGYGhh_ii * invGhh_ij + invGhhGYGhh_ij * invGhh_jj             # <<<<<<<<<<<<<<
 *             invGhhGYGhhinvGhh_ji = invGhhGYGhh_ji * invGhh_ii + invGhhGYGhh_jj * invGhh_ij
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":75
 *             invGhhGYGhhinvGhh_ii = invGhhGYGhh_ii * invGhh_ii + invGhhGYGhh_ij * invGhh_ij
 *             invGhhGYGhhinvGhh_ij = invGhhGYGhh_ii * invGhh_ij + invGhhGYGhh_ij * invGhh_jj
 *             invGhhGYGhhinvGhh_ji = invGhhGYGhh_ji * invGhh_ii + invGhhGYGhh_jj * invGhh_ij             # <<<<<<<<<<<<<<
 *             invGhhGYGhhinvGhh_jj = invGhhGYGhh_ji * invGhh_ij + invGhhGYGhh_jj * invGhh_jj
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":76
 *             invGhhGYGhhinvGhh_ij = invGhhGYGhh_ii * invGhh_ij + invGhhGYGhh_ij * invGhh_jj
 *             invGhhGYGhhinvGhh_ji = invGhhGYGhh_ji * invGhh_ii + invGhhGYGhh_jj * invGhh_ij
 *             invGhhGYGhhinvGhh_jj = invGhhGYGhh_ji * invGhh_ij + invGhhGYGhh_jj * invGhh_jj             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "rlscore/learner/_two_step_rls.pyx":78
 *             invGhhGYGhhinvGhh_jj = invGhhGYGhh_ji * invGhh_ij + invGhhGYGhh_jj * invGhh_jj
 * 
 *             results[i, j] = Y[i, j] - invGhhGYhh_ij - invGhhGYhh_ji + invGhhGYGhhinvGhh_ij             # <<<<<<<<<<<<<<
 * 
