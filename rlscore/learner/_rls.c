...
static const char __pyx_k_home_aatapa_Dropbox_python_RLSc[] = "/home/aatapa/Dropbox/python/RLScore/rlscore/learner/_rls.pyx";
...
static PyObject *__pyx_pw_7rlscore_7learner_4_rls_1leave_pair_out(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("leave_pair_out (wrapper)", 0);
  {
    ...
    __pyx_v_pairs_first = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[1]); if (unlikely(!__pyx_v_pairs_first.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_pairs_second = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[2]); if (unlikely(!__pyx_v_pairs_second.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
    ...
    __pyx_v_Y = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_Y.memview)) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_svecs = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5]); if (unlikely(!__pyx_v_svecs.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_bevals = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6]); if (unlikely(!__pyx_v_bevals.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_rank = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_rank == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_hatmatrixdiagonal = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8]); if (unlikely(!__pyx_v_hatmatrixdiagonal.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_svecsbevalssvecsTY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[9]); if (unlikely(!__pyx_v_svecsbevalssvecsTY.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_results_first = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[10]); if (unlikely(!__pyx_v_results_first.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_results_second = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[11]); if (unlikely(!__pyx_v_results_second.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
  }
 ...
 *                       long [:] pairs_second,
 */
  __pyx_tuple__14 = PyTuple_Pack(31, __pyx_n_s_pairslen, __pyx_n_s_pairs_first, __pyx_n_s_pairs_second, __pyx_n_s_outputlen, __pyx_n_s_Y, __pyx_n_s_svecs, __pyx_n_s_bevals, __pyx_n_s_rank, __pyx_n_s_hatmatrixdiagonal, __pyx_n_s_svecsbevalssvecsTY, __pyx_n_s_results_first, __pyx_n_s_results_second, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_pair_ind, __pyx_n_s_oind, __pyx_n_s_rind, __pyx_n_s_RQY_i, __pyx_n_s_RQY_j, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_d, __pyx_n_s_det, __pyx_n_s_ss_ii, __pyx_n_s_ss_ij, __pyx_n_s_ss_jj, __pyx_n_s_ia, __pyx_n_s_ib, __pyx_n_s_id, __pyx_n_s_lpo_i, __pyx_n_s_lpo_j); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(12, 0, 31, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_aatapa_Dropbox_python_RLSc, __pyx_n_s_leave_pair_out, 33, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 33, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_rls(void); /*proto*/
PyMODINIT_FUNC init_rls(void)
#else
PyMODINIT_FUNC PyInit__rls(void); /*proto*/
PyMODINIT_FUNC PyInit__rls(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__rls(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rlscore.learner._rls", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
