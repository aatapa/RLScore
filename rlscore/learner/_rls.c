...
static char __pyx_k_bevals[] = "bevals";
...
static char __pyx_k_rlscore_learner__rls[] = "rlscore.learner._rls";
...
static char __pyx_k_home_aatapa_Dropbox_python_RLSc[] = "/home/aatapa/Dropbox/python/RLScore/rlscore/learner/_rls.pyx";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "rlscore.learner._rls")) {
      if (unlikely(PyDict_SetItemString(modules, "rlscore.learner._rls", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                       long [:] pairs_second,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7rlscore_7learner_4_rls_1leave_pair_out, NULL, __pyx_n_s_rlscore_learner__rls); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
