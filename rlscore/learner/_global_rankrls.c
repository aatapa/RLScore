...
static const char __pyx_k_home_aatapa_Dropbox_python_RLSc[] = "/home/aatapa/Dropbox/python/RLScore/rlscore/learner/_global_rankrls.pyx";
static const char __pyx_k_rlscore_learner__global_rankrls[] = "rlscore.learner._global_rankrls";
...
static PyObject *__pyx_pw_7rlscore_7learner_15_global_rankrls_1leave_pair_out(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("leave_pair_out (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_pairslen)) != 0)) kw_args--;
    ...
    __pyx_v_pairs_first = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[2]); if (unlikely(!__pyx_v_pairs_first.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_pairs_second = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[3]); if (unlikely(!__pyx_v_pairs_second.memview)) __PYX_ERR(0, 37, __pyx_L3_error)
    ...
    __pyx_v_Y = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5]); if (unlikely(!__pyx_v_Y.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_svecs = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[6]); if (unlikely(!__pyx_v_svecs.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_modevals = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7]); if (unlikely(!__pyx_v_modevals.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_rank = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_rank == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_Gdiag = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[9]); if (unlikely(!__pyx_v_Gdiag.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_GC = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[10]); if (unlikely(!__pyx_v_GC.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_sm2Gdiag = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[11]); if (unlikely(!__pyx_v_sm2Gdiag.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    ...
    __pyx_v_GDY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[13]); if (unlikely(!__pyx_v_GDY.memview)) __PYX_ERR(0, 47, __pyx_L3_error)
    __pyx_v_BTY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[14]); if (unlikely(!__pyx_v_BTY.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_sqrtsm2GDY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[15]); if (unlikely(!__pyx_v_sqrtsm2GDY.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_BTGBBTY = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[16]); if (unlikely(!__pyx_v_BTGBBTY.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_CTY = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[17]); if (unlikely(!__pyx_v_CTY.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_CTGDY = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[18]); if (unlikely(!__pyx_v_CTGDY.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
    __pyx_v_results_first = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[19]); if (unlikely(!__pyx_v_results_first.memview)) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_results_second = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[20]); if (unlikely(!__pyx_v_results_second.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
  }
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_BTGBBTY.data + __pyx_t_24 * __pyx_v_BTGBBTY.strides[0]) ) + __pyx_t_25 * __pyx_v_BTGBBTY.strides[1]) )) = (((__pyx_v_sm2 * (*((double *) ( /* dim=0 */ (__pyx_v_Gdiag.data + __pyx_t_21 * __pyx_v_Gdiag.strides[0]) )))) * __pyx_v_sqrtsm2) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Y.data + __pyx_t_22 * __pyx_v_Y.strides[0]) ) + __pyx_t_23 * __pyx_v_Y.strides[1]) ))));
    }
  }
 ...
 */
    ...
    __pyx_t_29 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_Gdiag.data + __pyx_t_28 * __pyx_v_Gdiag.strides[0]) )))); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 84, __pyx_L1_error)
 ...
 */
    ...
    __pyx_t_29 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_Gdiag.data + __pyx_t_30 * __pyx_v_Gdiag.strides[0]) )))); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_29);
 ...
 *         GCipGCj = GCi + GCj
 */
    __pyx_t_36 = PyNumber_Add(__pyx_v_Gii, __pyx_v_Gij); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 94, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_39 = __pyx_PyFloat_AsDouble(__pyx_t_36); if (unlikely((__pyx_t_39 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L1_error)
 ...
 * 
 */
    __pyx_t_36 = PyNumber_Add(__pyx_v_Gij, __pyx_v_Gjj); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 95, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_39 = __pyx_PyFloat_AsDouble(__pyx_t_36); if (unlikely((__pyx_t_39 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 95, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
 ...
 *         BTGB00m1 = BTGB00 - 1.
 */
    __pyx_t_36 = PyFloat_FromDouble(__pyx_v_sm2); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_29 = PyNumber_Multiply(__pyx_t_36, __pyx_v_Gij); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_29);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __pyx_t_39 = __pyx_PyFloat_AsDouble(__pyx_t_29); if (unlikely((__pyx_t_39 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 101, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
 ...
 */
      ...
      __pyx_t_29 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_GDY.data + __pyx_t_64 * __pyx_v_GDY.strides[0]) ) + __pyx_t_65 * __pyx_v_GDY.strides[1]) )))); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_29);
      __pyx_t_36 = PyFloat_FromDouble(__pyx_v_t1); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __pyx_t_66 = PyNumber_Multiply(__pyx_v_Gii, __pyx_t_36); if (unlikely(!__pyx_t_66)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_66);
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
      __pyx_t_36 = PyFloat_FromDouble(__pyx_v_t2); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __pyx_t_67 = PyNumber_Multiply(__pyx_v_Gij, __pyx_t_36); if (unlikely(!__pyx_t_67)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_67);
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
      __pyx_t_36 = PyNumber_Add(__pyx_t_66, __pyx_t_67); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
      __Pyx_DECREF(__pyx_t_67); __pyx_t_67 = 0;
      __pyx_t_67 = PyFloat_FromDouble((__pyx_v_GCi * __pyx_v_b0)); if (unlikely(!__pyx_t_67)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_67);
      __pyx_t_66 = PyNumber_Add(__pyx_t_36, __pyx_t_67); if (unlikely(!__pyx_t_66)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_66);
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
      __Pyx_DECREF(__pyx_t_67); __pyx_t_67 = 0;
      __pyx_t_67 = PyNumber_Subtract(__pyx_t_29, __pyx_t_66); if (unlikely(!__pyx_t_67)) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_67);
      __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
      __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
      __pyx_t_39 = __pyx_PyFloat_AsDouble(__pyx_t_67); if (unlikely((__pyx_t_39 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 133, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_67); __pyx_t_67 = 0;
 ...
 */
      ...
      __pyx_t_67 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_GDY.data + __pyx_t_68 * __pyx_v_GDY.strides[0]) ) + __pyx_t_69 * __pyx_v_GDY.strides[1]) )))); if (unlikely(!__pyx_t_67)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_67);
      __pyx_t_66 = PyFloat_FromDouble(__pyx_v_t1); if (unlikely(!__pyx_t_66)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_66);
      __pyx_t_29 = PyNumber_Multiply(__pyx_v_Gij, __pyx_t_66); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_29);
      __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
      __pyx_t_66 = PyFloat_FromDouble(__pyx_v_t2); if (unlikely(!__pyx_t_66)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_66);
      __pyx_t_36 = PyNumber_Multiply(__pyx_v_Gjj, __pyx_t_66); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
      __pyx_t_66 = PyNumber_Add(__pyx_t_29, __pyx_t_36); if (unlikely(!__pyx_t_66)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_66);
      __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
      __pyx_t_36 = PyFloat_FromDouble((__pyx_v_GCj * __pyx_v_b0)); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __pyx_t_29 = PyNumber_Add(__pyx_t_66, __pyx_t_36); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_29);
      __Pyx_DECREF(__pyx_t_66); __pyx_t_66 = 0;
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
      __pyx_t_36 = PyNumber_Subtract(__pyx_t_67, __pyx_t_29); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_36);
      __Pyx_DECREF(__pyx_t_67); __pyx_t_67 = 0;
      __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
      __pyx_t_39 = __pyx_PyFloat_AsDouble(__pyx_t_36); if (unlikely((__pyx_t_39 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_results_second.data + __pyx_t_72 * __pyx_v_results_second.strides[0]) ) + __pyx_t_73 * __pyx_v_results_second.strides[1]) )) = __pyx_v_F1;
    }
  }
 ...
 *                       long [:] pairs_first,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7rlscore_7learner_15_global_rankrls_1leave_pair_out, NULL, __pyx_n_s_rlscore_learner__global_rankrls); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
