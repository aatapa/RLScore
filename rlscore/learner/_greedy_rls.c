...
__pyx_t_7 = __pyx_memoryview_fromslice(__pyx_t_6, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 55, __pyx_L1_error)
...
static PyObject *__pyx_pw_7rlscore_7learner_11_greedy_rls_1find_optimal_feature(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("find_optimal_feature (wrapper)", 0);
  {
    ...
    __pyx_v_Y = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_Y.memview)) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_X = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_X.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_GXT = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2]); if (unlikely(!__pyx_v_GXT.memview)) __PYX_ERR(0, 35, __pyx_L3_error)
    __pyx_v_diagG = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3]); if (unlikely(!__pyx_v_diagG.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_dualvec = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_dualvec.memview)) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_looperf = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5]); if (unlikely(!__pyx_v_looperf.memview)) __PYX_ERR(0, 38, __pyx_L3_error)
    ...
    __pyx_v_selected = __Pyx_PyObject_to_MemoryviewSlice_ds_short(values[9]); if (unlikely(!__pyx_v_selected.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_tempvec1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[10]); if (unlikely(!__pyx_v_tempvec1.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_tempvec2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[11]); if (unlikely(!__pyx_v_tempvec2.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_tempvec3 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[12]); if (unlikely(!__pyx_v_tempvec3.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
  }
